...
public class Unsubscriber extends ActiveRecord implements Serializable
{
    ...
    public String lname;
    @Column(name = "drop_id", type = "integer", nullable = true)
    public int dropId;
    ...
    public Unsubscriber() throws DatabaseException {
        super();
    ...
    public Unsubscriber(final Object primaryValue) throws DatabaseException {
        super(primaryValue);
        this.setDatabase("lists");
        this.setSchema("");
        this.setTable("");
