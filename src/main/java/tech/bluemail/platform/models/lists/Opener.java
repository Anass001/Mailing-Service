...
public class Opener extends ActiveRecord implements Serializable
{
    ...
    public Opener() throws DatabaseException {
        super();
    ...
    public Opener(final Object primaryValue) throws DatabaseException {
        super(primaryValue);
        this.setDatabase("lists");
        this.setSchema("");
        this.setTable("");
